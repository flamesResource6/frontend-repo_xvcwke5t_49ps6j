    ...
    <section id="industries" className="relative py-24">
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-semibold text-white">Where Voltiq excels</h2>
          <p className="mt-3 text-white/70">Designed for multilingual teams across Europe and Asia. We blend Alpine reliability with Shenzhen speed.</p>
        </div>
